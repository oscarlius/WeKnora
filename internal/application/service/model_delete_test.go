...
func (s *stubTenantServiceForModelDelete) UpdateStorageQuota(context.Context, uint64, int64) (*types.Tenant, error) {
	return s.tenant, nil
}
func (s *stubTenantServiceForModelDelete) GetTenantStorageStats(context.Context, uint64) (*types.TenantStorageStats, error) {
	return &types.TenantStorageStats{}, nil
}
