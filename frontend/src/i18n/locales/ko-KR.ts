export default {
  ...
  knowledgeEditor: {
    vlmChain: {
      orderLabel: 'VLLM 모델 순서',
      orderDescription: '이미지 이해 모델을 순서대로 시도하며, 오류/시간 초과/빈 응답이면 다음 모델로 자동 전환합니다.',
      primaryLabel: '기본 VLLM 모델',
      fallbackLabelPrefix: '대체 모델',
      primaryPlaceholder: '기본 VLLM 모델을 선택하세요',
      fallbackPlaceholder: '대체 VLLM 모델을 선택하세요',
      addFallback: '대체 모델 추가',
      up: '위로',
      down: '아래로',
      remove: '삭제',
      hint: '순서대로 시도하며 최대 {max}개까지 설정할 수 있습니다. 오류, 시간 초과 또는 빈 응답은 다음 모델로 전환됩니다.',
      duplicateWarning: '이 VLLM 모델은 이미 순서 목록에 있습니다.'
    },
    ...
    wiki: {
      synthesisPrimaryLabel: '기본 합성 모델',
      synthesisFallbackLabelPrefix: '대체 모델',
      synthesisFallbackPlaceholder: '대체 Wiki 합성 모델을 선택하세요',
      synthesisAddFallback: '대체 모델 추가',
      synthesisModelChainHint: '기본 모델이 비어 있으면 요약 모델을 사용합니다. 모델 호출 오류가 발생하면 최대 {max}개 모델을 순서대로 시도합니다.',
      synthesisDuplicateWarning: '이 합성 모델은 이미 목록에 있습니다.',
      title: 'Wiki 설정',
