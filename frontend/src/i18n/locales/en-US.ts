export default {
  ...
  knowledgeEditor: {
    ...
    vlmChain: {
      orderLabel: 'VLLM model order',
      orderDescription: 'Try image-understanding models in order. On error, timeout, or blank response, the next model is used automatically.',
      primaryLabel: 'Primary VLLM model',
      fallbackLabelPrefix: 'Fallback model',
      primaryPlaceholder: 'Select the primary VLLM model',
      fallbackPlaceholder: 'Select a fallback VLLM model',
      addFallback: 'Add fallback model',
      up: 'Move up',
      down: 'Move down',
      remove: 'Remove',
      hint: 'Tried in order, up to {max} models. Errors, timeouts, or blank responses switch to the next model.',
      duplicateWarning: 'This VLLM model is already in the ordered list.',
    },
    navGroups: {
      basic: 'Basics',
    ...
    wiki: {
      ...
      synthesisPrimaryLabel: 'Primary synthesis model',
      synthesisFallbackLabelPrefix: 'Fallback model',
      synthesisFallbackPlaceholder: 'Select a fallback synthesis model',
      synthesisAddFallback: 'Add fallback model',
      synthesisModelChainHint: 'Uses the summary model when primary is empty. On model-call errors, tries up to {max} models in order.',
      synthesisDuplicateWarning: 'This synthesis model is already in the ordered list.',
...
\
    ...
    advanced: {
      ...
      multimodal: {
        ...
        fallbackVllmDescription: 'Backup model used automatically when the primary vision model request fails',
