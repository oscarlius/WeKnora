...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    vlmChain: {
      orderLabel: 'Порядок VLLM моделей',
      orderDescription: 'Модели для понимания изображений пробуются по порядку. При ошибке, тайм-ауте или пустом ответе автоматически используется следующая модель.',
      primaryLabel: 'Основная VLLM модель',
      fallbackLabelPrefix: 'Резервная модель',
      primaryPlaceholder: 'Выберите основную VLLM модель',
      fallbackPlaceholder: 'Выберите резервную VLLM модель',
      addFallback: 'Добавить резервную модель',
      up: 'Вверх',
      down: 'Вниз',
      remove: 'Удалить',
      hint: 'Пробуются по порядку, максимум {max}. Ошибки, тайм-ауты или пустые ответы переключают на следующую модель.',
      duplicateWarning: 'Эта VLLM модель уже есть в списке.',
    },
    navGroups: {
      basic: 'Основное',
    ...
    wiki: {
      ...
      synthesisPrimaryLabel: 'Основная модель синтеза',
      synthesisFallbackLabelPrefix: 'Резервная модель',
      synthesisFallbackPlaceholder: 'Выберите резервную модель синтеза Wiki',
      synthesisAddFallback: 'Добавить резервную модель',
      synthesisModelChainHint: 'Если основная модель не задана, используется модель суммаризации. При ошибках вызова система пробует до {max} моделей по порядку.',
      synthesisDuplicateWarning: 'Эта модель синтеза уже есть в списке.',
    ...
    advanced: {
      ...
      multimodal: {
        ...
        fallbackVllmLabel: 'Резервная VLLM модель',
        fallbackVllmDescription: 'Резервная модель, которая используется при ошибке основного визуального запроса',
        fallbackVllmPlaceholder: 'Выберите резервную VLLM модель (необязательно)',
