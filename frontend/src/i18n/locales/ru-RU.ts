export default {
  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      multimodal: {
        fallbackVllmLabel: 'Fallback VLLM Model',
        fallbackVllmDescription: 'Optional backup model used when the primary VLLM request fails',
        fallbackVllmPlaceholder: 'Select a fallback VLLM model (optional)',
